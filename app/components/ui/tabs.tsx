...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      border-transparent px-3 py-1.5 text-sm font-medium transition-all hover:bg-accent
      hover:text-primary focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50
