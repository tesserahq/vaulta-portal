...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      bg-transparent px-3 py-2 text-sm ring-offset-background transition-all duration-100
      placeholder:text-muted-foreground hover:border-primary focus:outline-none focus:ring-2
